...
public class EncryptUtils
{
    ...
    {
        String key = "#AdFwEsdf@sdfsa=|#4"; 
        String password = "1234234234.01"; 
        System.out.println("key=" + key + ",password=" + password);  
        String encrypt = "";
        String decrypt = ""; 
        encrypt = EncryptUtils.Encrypt3DES(password, key);
        System.out.println("调用原始密钥算加密结果=" + encrypt);
        decrypt = EncryptUtils.Decrypt3DES(encrypt, key); 
        System.out.println("调用原始密钥算解密结果=" + decrypt); 
    }
