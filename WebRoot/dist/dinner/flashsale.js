...
function ajaxFunc() {
    ...
    $.ajax({
        type : 'post',
        url : '/index/dinner/listFlashsale.do',
        data : dataParams,
        dataType : 'json',
        beforeSend : function() {
        ...
        success : function(data) {
            ...
            if (0 == len) {
                ...
                for ( var i = 0; i < len; i++) {
                    ...
                    temp += "<p class='name'>" + content[i].cookName + "</p>";
                    ...
                    temp += "<a class='rush-purchase' href='/index/dinner/detail.do?cookbooksId=" + content[i].cookbooksId + "'>马上抢</a>";
                    temp += "</li>";
                }
