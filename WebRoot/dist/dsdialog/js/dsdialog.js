...
; (function(global, document, $, undefined) {
    ...
    _ops = {
        ...
        zIndex: 1990,
        icon: null,
        iconBasePath: global.iconBasePath || '/dist/dsdialog/images/',
        buttons: null,
        follow: null,
        followOffset: null,
        autoOpen: true,
    ...
    $.extend(ds.dialog, {
        ...
        powerEdit: function(content, onyes, onno, onhide) {
            return new Dialog({
                id: 'ds_dialog_confirm',
                fixed: true,
                left: '50%',
                top: '40%', 
                title: '\u6d88\u606f\u786e\u8ba4',
                content: '<iframe src="/manager/sys/editPower.do" border="0" style="border: 0px none; width: 400px; height: 450px;"">' , 
                onyes: onyes || true,
                onhide: onhide,
                onno: onno || true
            });
